...
const list = [
        {id: "equalEarth", name: "Equal Earth", list: ['global'],
        type: 'Pseudo-cylindrique', scale: "Globale", area: 3, distance: 1, angle: 1,
        ...
        {id: "naturalEarth2", name: "Natural Earth 2", list: ['global'],
        type: 'Pseudo-cylindrique', scale: "Globale", area: 2, distance: 3, angle: 1,
        ...
        {id: "armadillo", name: "Armadillo", list: ['global'],
        type: 'Autre', scale: "Globale", area: 1, distance: 0, angle: 1,
        ...
        {id: "bertin53", name: "Bertin 1953", list: ['global'],
        type: 'Autre', scale: "Globale", area: 2, distance: 1, angle: 0,
        ...
        {id: "bonne", name: "Bonne", list: ['global'],
        type: 'Pseudo-conique', scale: "Globale", area: 1, distance: 1, angle: 0,
        ...
        {id: "orthographic", name: "Orthographique", list: ['regional'],
        type: 'Azimutale', scale: "Régionale", area: 1, distance: 1, angle: 1,
        ...
        {id: "interruptedMollweide", name: "Mollweide interrompue", list: ['global', 'regional'],
        type: 'Pseudo-cylindrique', scale: "Globale ou régionale", area: 3, distance: 1, angle: 0,
        ...
        {id: "atlantis", name: "Atlantis", list: ['global'],
        type: 'Pseudo-cylindrique', scale: "Globale", area: 3, distance: 1, angle: 0,
        ...
        {id: "satellite", name: "Satellite", list: ['regional', 'local'],
        type: 'Autre', scale: "Régionale ou locale", area: 1, distance: 1, angle: 1,
        ...
        {id: "mercator", name: "Mercator", list: ['regional', 'local'],
        type: 'Cylindrique', scale: "Régionale ou locale", area: 0, distance: 0, angle: 3,
        ...
        {id: "equirectangular", name: "Plate Carrée", list: ['regional', 'local'],
        type: 'Cylindrique', scale: "Régionale ou locale", area: 1, distance: 3, angle: 1,
        ...
        {id: "mollweideHemisphere", name: "Mollweide interrompue en 2 hémisphères", list: ['global'],
        type: 'Pseudo-cylindrique', scale: "Globale", area: 3, distance: 1, angle: 0,
        ...
        {id: "laea", name: "Lambert azimutale équivalente (LAEA)", list: ['global', 'regional'],
        type: 'Azimutale', scale: "Globale ou régionale", area: 3, distance: 1, angle: 0,
